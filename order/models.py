...
class OrderNew(models.Model):
    ...
    order_dop_title1 = models.CharField(max_length=400, verbose_name='Доп-характеристика№1', blank=True)
    order_dop_title2 = models.CharField(max_length=400, verbose_name='Значение доп-характеристики№1', blank=True)
    order_dop_title3 = models.CharField(max_length=400, verbose_name='Доп-характеристика2', blank=True)
    order_dop_title4 = models.CharField(max_length=400, verbose_name='Значение доп-характеристики№2', blank=True)
    order_dop_title5 = models.CharField(max_length=400, verbose_name='Доп-характеристика3', blank=True)
    order_dop_title6 = models.CharField(max_length=400, verbose_name='Значение доп-характеристики№3', blank=True)
